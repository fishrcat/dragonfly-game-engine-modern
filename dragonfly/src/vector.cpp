...
float Vector::getX() const noexcept { return m_x; }

float Vector::getY() const noexcept { return m_y; }

void Vector::setX(float x) noexcept { m_x = x; }

void Vector::setY(float y) noexcept { m_y = y; }
